public static Tuple getTuple(double freq) {
	...
	switch (freq) {
		...
		case 104.0: 
			temp.add(4);
			return new Tuple("E", "4", 104, 1, false);
		...
		case 185.0: 
			...
			temp.add(9);
			temp.add(13);
			return new Tuple("D", "4", 185, 1, false);
		...
		case 311.0: 
			...
			temp.add(13);
			temp.add(18);
			return new Tuple("B", "4", 311, 1, false);
		...
		case 659.0: 
			temp.add(12);
			temp.add(17);
			return new Tuple("e", tmep, 659, 1, false);
		case 698.0: 
			temp.add(13);
			temp.add(18);
			return new Tuple("e", tmep, 698, 1, false);
		case 740.0: 
			temp.add(14);
			temp.add(19);
		...
		default: return new Tuple("?", temp, -1, 1, false);
	}
}