...
public class Tuple {
    ...
    public String[] updateStrings(ArrayList<Tuple> section) {

        ArrayList<Tuple> tupleArray = section;
        ...
        for (int j = 0; j < 30 - estring.length(); j++) {
            restOf_e_dashes = restOf_e_dashes + "-";
        }

        for (int j = 0; j < 30 - Bstring.length(); j++) {
            restOf_B_dashes = restOf_B_dashes + "-";
        }

        for (int j = 0; j < 30 - Gstring.length(); j++) {
            restOf_G_dashes = restOf_G_dashes + "-";
        }

        for (int j = 0; j < 30 - Dstring.length(); j++) {
            restOf_D_dashes = restOf_D_dashes + "-";
        }

        for (int j = 0; j < 30 - Astring.length(); j++) {
