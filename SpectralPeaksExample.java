...
Email verification helps our support team verify ownership if you lose account access and allows you to receive all the notifications you ask for.
 Watch 62
  Star 345
 Fork 124 JorenSix/TarsosDSP
 Code  Issues 9  Pull requests 1  Pulse  Graphs
Tree: 71ae353871 Find file Copy pathTarsosDSP/src/examples/be/tarsos/dsp/example/spectrum/SpectralPeaksExample.java
e2898c2  on Mar 3, 2015
@JorenSix JorenSix Modified souce code structure. Now all source code can be found in src.
1 contributor
RawBlameHistory     463 lines (389 sloc)  15.3 KB
/*
...
public class SpectralPeaksExample extends JFrame {
	...
	//frequencies = method(x).method2(0.method3(0...(methodN(Audio event))))
	//method2(y)
	//...
	//methodN(z)
	//for(frequncy : frequencies) {
		if(has a base and minor 5th)
	}
